...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		//BaseUrl = "http://localhost:8081/ckeditor/ckfinder/userfiles/";
		BaseUrl = "/ckeditor/ckfinder/userfiles/";

		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
		BaseDir = "";
		//BaseDir = "E:/LamPhanMem/AngularJS/Web_Sale_3/ckeditor/ckfinder/userfiles/";
		//BaseDir = "/ckeditor/ckfinder/userfiles/";
		//E:\LamPhanMem\AngularJS\Web_Sale_3\ckeditor\ckfinder
